...
(* OASIS_START *)
(* DO NOT EDIT (digest: 14d4b43e4c1842796a1c37c4a7bfcb43) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Jer\195\180me Vouillon"; "Jan Rochel"];
          homepage = Some "https://github.com/besport/bs-aws";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "this is not nearly a complete implementation of the AWS API and is not actively developed"
              ];
          tags = [];
          categories = [];
          files_ab = [];
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Aws_base"; "Aws_request"; "Aws_signature"];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/besport/bs-aws.git";
                      src_repo_browser =
                        Some "https://github.com/besport/bs-aws";
     ...
     oasis_digest = Some " \248\237\168+\164\200\207\194@mx\002\193\141\236";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
